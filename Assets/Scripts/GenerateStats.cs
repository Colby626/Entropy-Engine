...
public class GenerateStats : MonoBehaviour
{
    ...
    public void GenerateStatPoints()
    {
        ...
        characterList.GenerateNPC(new CharacterList.NPC()
        {
            ...
            MaxHealth = enduranceStat * 2, //CalculateHealth(),
            CurrentHealth = enduranceStat * 2, //CalculateHealth(),
            MaxMana = spiritStat * 2, //CalculateMana(),
            CurrentMana = spiritStat * 2, //CalculateMana(),
            DR = 0, //enduranceStat / 5,
            PlusToHit = dexterityStat / 10 >= 15 ? 15 : dexterityStat / 10,
            InitiativeBonus = CalculateInitiativeBonus(),
            CriticalBonus = dexterityStat, //CalculateCriticalBonus(),
            MovementSpeed = 3 + (agilityStat / 10),
            StrengthDamageBonus = strengthStat / 2, //CalculateStatBonus(strengthStat),
            DexterityDamageBonus = dexterityStat / 2, //CalculateStatBonus(dexterityStat),
            SpiritDamageBonus = spiritStat / 2, //CalculateStatBonus(spiritStat),
